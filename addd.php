...
<form class="login__form" method="post" action="checkconx.php">
        <div class="login__row">
          ...
          <input type="text" name="nom" class="login__input name" placeholder="nom"/>
          <input type="text" name="prenom" class="login__input name" placeholder="prenom"/>
        ...
        <input type="submit" name="add"  value="stajal" class="login__submit"/>
